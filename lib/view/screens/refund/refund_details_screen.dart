...
import 'package:wave_mall_vendor/view/screens/refund/widget/change_log_widget.dart';
import 'package:wave_mall_vendor/view/screens/refund/widget/refund_details.dart';
    ...
    return Scaffold(
        ...
        body: Consumer<RefundProvider>(
            builder: (context,refundReq,_) {
              return RefundDetailScreen(refundModel: widget.refundModel, orderDetailsId: widget.orderDetailsId,variation: widget.variation);
            }
        )
    );
  }
