      ...
      body: Consumer<ProfileProvider>(
        builder: (context, profileProvider, _) {
          return SingleChildScrollView(
            ...
            child: profileProvider.notificationModel != null? (profileProvider.notificationModel!.notification != null && profileProvider.notificationModel!.notification!.isNotEmpty)?
            PaginatedListView(
              ...
              itemView: ListView.builder(
                shrinkWrap: true,
                  itemCount: profileProvider.notificationModel?.notification?.length,
                  physics: const NeverScrollableScrollPhysics(),
                  padding: EdgeInsets.zero,
                  addAutomaticKeepAlives: false,
                  addRepaintBoundaries: false,
                  itemBuilder: (context, index){
                return NotificationCard(notificationItem: profileProvider.notificationModel!.notification![index]);
              }),):const Center(child: NoDataScreen()):const CustomLoader(),
          );
        }
      ),
    );
...
class NotificationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(onTap: (){
        Provider.of<ProfileProvider>(context, listen: false).seenNotification(notificationItem.id!);
      ...
      child: Padding(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
          ...
          Text.rich(TextSpan(children: [
            ...
            CustomButton(btnTxt: '${getTranslated('visit', context)}', onTap: (){
              _launchUrl('${AppConstants.baseUrl}/shopView/${Provider.of<ProfileProvider>(context, listen: false).userId}');
            },)
