...
import 'package:wave_mall_vendor/view/screens/chat/chat_screen.dart';
...
class ChatCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    '${chat!.deliveryMan?.fName??''} ${chat!.deliveryMan?.lName??'Deleted'}';
    ...
    return Padding(padding:  const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraSmall),
      child: InkWell(onTap: (){
        ...
        if(name.trim() == "Deleted"){
          showCustomSnackBar('Account was deleted', context);
        }else{
