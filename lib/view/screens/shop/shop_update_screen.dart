...
class ShopUpdateScreenState extends State<ShopUpdateScreen> {
  ...
  _updateShop() async {
    ...
    Provider.of<AuthProvider>(context, listen: false).shopBanner == null &&
        Provider.of<AuthProvider>(context, listen: false).secondaryBanner == null &&
      ...
      await Provider.of<ShopProvider>(context, listen: false).updateShopInfo(updateShopModel : updateShopModel, file : file);
    }
  }
              ...
              return Column(children: [
                  ...
                  Expanded(child: Container(
                    ...
                    child: ListView(
                              ...
                              child: Container(width : 150, height: 150, alignment: Alignment.center,
                                ...
                                child: Stack(clipBehavior: Clip.none, children: [
                                  ClipRRect(borderRadius: BorderRadius.circular(10),
                                    child: file == null ? CustomImage(height: 140,width: 140,
                      ...
                      if(Provider.of<SplashProvider>(context, listen: false).configModel!.activeTheme == "theme_aster")
                            ...
                            child: Stack(children: [
                              ClipRRect(borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                  child: authProvider.offerBanner != null ?  Image.file(File(authProvider.offerBanner!.path),
                                      ...
                                      width: MediaQuery.of(context).size.width - 40,
                                      child: CustomImage(image: '${Provider.of<SplashProvider>(context,listen: false).
                                      baseUrls!.shopImageUrl}/banner/${shop.shopModel!.offerBanner}'))),
