...
import 'package:wave_mall_vendor/view/screens/forgetPassword/widget/reset_password_widget.dart';
                            ...
                            if(phoneVerification){
                              Provider.of<AuthProvider>(context, listen: false).verifyOtp(mobileNumber).then((value) {
                                if(value.isSuccess) {
                                  ...
                                  showCustomSnackBar(getTranslated('input_valid_otp', context), context);
                                }
                              });
                            }
                          },
