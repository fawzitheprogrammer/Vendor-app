...
import 'package:wave_mall_vendor/view/base/custom_date_picker.dart';
import 'package:wave_mall_vendor/view/base/custom_drop_down_item.dart';
...
class _AddNewCouponScreenState extends State<AddNewCouponScreen> {
  ...
  void initState() {
    ...
    if(update){
      ...
      Provider.of<CouponProvider>(context, listen: false).startDate = DateTime.parse(widget.coupons!.startDate!);
      Provider.of<CouponProvider>(context, listen: false).endDate = DateTime.parse(widget.coupons!.expireDate!);
    }
        ...
        builder: (context, coupon,_) {
          return SingleChildScrollView(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              ...
              Padding(padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault, Dimensions.paddingSizeSmall, Dimensions.paddingSizeDefault, Dimensions.paddingSizeExtraSmall),
              ...
              return Consumer<CartProvider>(
                builder: (context, customer,_) {
                  return Padding(
                    ...
                    CustomButton(btnTxt:update? getTranslated('update', context) : getTranslated('submit', context),
                    onTap: (){
                      ...
                      if(couponTitle.isEmpty){
                        ...
                        showCustomSnackBar(getTranslated('max_discount_is_required', context), context);
