...
import 'package:wave_mall_vendor/view/screens/coupon/widget/coupon_details_dialog.dart';
...
class CouponCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if((coupons!.addedBy =='seller' || (coupons!.addedBy =='admin' && coupons!.couponBearer =='seller' && coupons!.sellerId == Provider.of<ProfileProvider>(context, listen: false).userId))){
    adminCoupon = false;
    }else{
    adminCoupon = true;
    }
