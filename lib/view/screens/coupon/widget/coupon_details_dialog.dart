                ...
                Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      const SizedBox(height: Dimensions.paddingSizeSmall,),
                        ...
                        Text('${getTranslated('code', context)} : ${coupons!.code}',
                          style: robotoBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: ColorResources.getTextTitle(context))),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        Text(getTranslated(coupons!.couponType, context)!, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                      ],
                    )
                  ]),
                  Padding(padding: const EdgeInsets.only(left: 30),
                    child: Column(children: [
                      Row(children: [
                        Text('${getTranslated('minimum_purchase', context)} : ', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                        Text(PriceConverter.convertPrice(context, coupons!.minPurchase), style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),),
                      ],),
                      const SizedBox(height: Dimensions.paddingSizeMedium,),
                      Row(children: [
                        Text('${getTranslated('maximum_discount', context)} : ', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                        Text(PriceConverter.convertPrice(context, coupons!.minPurchase), style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                      ],),
                      const SizedBox(height: Dimensions.paddingSizeMedium,),
                      Row(children: [
                        Text('${getTranslated('start_from', context)} : ', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                        Text(DateConverter.isoStringToDateTimeString(coupons!.createdAt!), style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),),
                      ],),
                      const SizedBox(height: Dimensions.paddingSizeMedium,),
                      Row(children: [
                        Text('${getTranslated('expires_on', context)} : ', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                        Text(DateConverter.isoStringToDateTimeString(coupons!.expireDate!), style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),),
                      ],),
                    ],),
                  )
                ],),
