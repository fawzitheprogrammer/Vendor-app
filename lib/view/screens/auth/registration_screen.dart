...
import 'package:wave_mall_vendor/data/model/body/register_model.dart';
...
import 'package:wave_mall_vendor/view/screens/auth/widgets/info_field_view.dart';
import 'package:wave_mall_vendor/view/screens/auth/widgets/register_successfull_dialog.dart';
                                          ...
                                          if (authProvider.firstNameController.text
                                            ...
                                            showCustomSnackBar(
                                                getTranslated(
                                                    ...
                                                    context),
                                                context);
                                          } else if (authProvider.secondaryBanner == null && Provider.of<SplashProvider>(context, listen: false).configModel!.activeTheme != "default") {
                                            showCustomSnackBar(
                                                getTranslated(
                                            ...
                                            RegisterModel registerModel = RegisterModel(
                                                ...
                                                lName: authProvider
                                                    ...
                                                    .trim(),
                                                phone:
                                                    '+964${authProvider.phoneController.text.trim()}',
                                                email: authProvider
