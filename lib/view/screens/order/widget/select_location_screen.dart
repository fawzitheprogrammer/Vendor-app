...
import 'package:wave_mall_vendor/view/screens/order/widget/location_search_dialog.dart';
          ...
          return Stack(
            ...
            InkWell(onTap: () => _openSearchDialog(context, _controller),
              child: Container(width: MediaQuery.of(context).size.width, height: 55,
                ...
                child: Row(children: [
                  Expanded(child: Text(locationProvider.locationController.text.trim(), maxLines: 1, overflow: TextOverflow.ellipsis)),
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                ...
                SizedBox(width: double.infinity,
                  child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                    child: CustomButton(btnTxt: getTranslated('select_location', context),
                      onTap: () {
