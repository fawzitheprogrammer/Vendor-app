...
import 'package:wave_mall_vendor/view/screens/order/widget/delivery_man_assign_widget.dart';
...
class OrderSetup extends StatefulWidget {
  ...
  const OrderSetup({Key? key, this.orderModel, this.onlyDigital = false}) : super(key: key);
...
class _OrderSetupState extends State<OrderSetup> {
  ...
  Widget build(BuildContext context) {
    ...
    if(shipping == 'inhouse_shipping' && (widget.orderModel!.orderStatus == 'out_for_delivery' || widget.orderModel!.orderStatus == 'delivered' || widget.orderModel!.orderStatus == 'returned' || widget.orderModel!.orderStatus == 'failed' || widget.orderModel!.orderStatus == 'canceled')){
