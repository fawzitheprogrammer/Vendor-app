        ...
        builder: (cont, shippingProvider, _) {
          return Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Padding(padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault,
                Dimensions.paddingSizeExtraLarge, Dimensions.paddingSizeDefault, Dimensions.paddingSizeSmall),
              ...
              builder: (context, splash, child) {
                ...
                return Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                  child: GridView.builder(
                    ...
                    return GestureDetector(onTap: ()=> shippingProvider.setShippingType(i),
                      child: Container(
                        decoration: BoxDecoration(color:  shippingProvider.shippingIndex ==i?
                        Theme.of(context).primaryColor: Theme.of(context).cardColor,
                        borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                        boxShadow: [BoxShadow(color: Provider.of<ThemeProvider>(context, listen: false).darkTheme?
                        ...
                        child: Stack(children: [
                          ...
                          Align(alignment : Alignment.topRight,
                              child: Padding(padding: const EdgeInsets.all(3.0), child: Icon(Icons.check_circle, color: Theme.of(context).cardColor),
                              )):const SizedBox()
                      ],),),
                    );
                  }),
            ...
            Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
              child: Row(children: [
                Expanded(child: CustomButton(fontColor: ColorResources.getTextColor(context),
                      btnTxt: getTranslated('cancel', context),
                  backgroundColor: Theme.of(context).hintColor.withOpacity(.5),
                  onTap: () => Navigator.pop(context))),
                const SizedBox(width: Dimensions.paddingSizeDefault,),
                Expanded(child: CustomButton(fontColor: Colors.white,
                    btnTxt: getTranslated('update', context), onTap: (){
                  String? type;
