...
import 'package:wave_mall_vendor/view/screens/top_delivery_man/top_delivery_man_screen.dart';
import 'package:wave_mall_vendor/view/screens/top_delivery_man/widget/top_delivery_man_widget.dart';
          ...
          Padding(
            ...
            child: GridView.builder(
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                mainAxisSpacing: 5,
                crossAxisSpacing: 5,
                childAspectRatio: MediaQuery.of(context).size.width < 400? 1/1.23: MediaQuery.of(context).size.width < 420? 1/.97 : 1/.95,
              ),
