...
import 'package:wave_mall_vendor/view/screens/delivery/widget/delivery_man_earning_view_all_screen.dart';
      ...
      child: Consumer<DeliveryManProvider>(
        builder: (context, earningProvider,_) {
          ...
          return Column(children: [
              ...
              Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeMedium, vertical: Dimensions.paddingSizeExtraSmall),
