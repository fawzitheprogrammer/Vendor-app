...
import 'package:wave_mall_vendor/view/screens/delivery/widget/delivery_man_list_view.dart';
...
class _DeliveryManListScreenState extends State<DeliveryManListScreen> {
  ...
  @override
  void initState() {
    Provider.of<DeliveryManProvider>(context, listen: false).deliveryManListURI(1,'');
    super.initState();
  }
          ...
          SliverPersistentHeader(delegate: SliverDelegate(
            ...
            child : Padding(
              ...
              child: CustomSearchField(
                ...
                onSubmit: (text) => (){},
                onChanged: (value){
                  Provider.of<DeliveryManProvider>(context, listen: false).deliveryManListURI(1, value);
                },
                isFilter: false,
              ),
            )
