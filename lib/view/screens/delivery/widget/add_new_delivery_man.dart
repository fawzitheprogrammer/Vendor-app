...
import 'package:wave_mall_vendor/view/screens/delivery/delivery_man_setup.dart';
import 'package:wave_mall_vendor/view/screens/delivery/widget/delivery_man_info.dart';
...
class _AddNewDeliveryManScreenState extends State<AddNewDeliveryManScreen> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    if(widget.deliveryMan != null){
      ...
      Provider.of<DeliveryManProvider>(context, listen: false).firstNameController.clear();
      Provider.of<DeliveryManProvider>(context, listen: false).lastNameController.clear();
      Provider.of<DeliveryManProvider>(context, listen: false).emailController.clear();
      Provider.of<DeliveryManProvider>(context, listen: false).phoneController.clear();
      Provider.of<DeliveryManProvider>(context, listen: false).addressController.clear();
      Provider.of<DeliveryManProvider>(context, listen: false).identityNumber.clear();
            ...
            return Column( children: [
              ...
              Expanded(child: TabBarView(
                ...
                children: [
                  ...
                  DeliveryManInfo(isPassword : true,deliveryMan: widget.deliveryMan),
                ],
              )),
            ]);
          }
              ...
              children: [
                ...
                Container(height: 70,
                  ...
                  Row(children: [
                      ...
                      deliveryManProvider.isLoading? const CircularProgressIndicator():
                      Expanded(child:
