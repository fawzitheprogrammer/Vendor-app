...
class _POSProductScreenState extends State<POSProductScreen> {
  @override
  void initState() {
    Provider.of<ProductProvider>(context, listen: false).shoHideDialog(false, notify: false);
                          ...
                          child: CustomSearchField(
                            ...
                            filterAction: (){
                              showModalBottomSheet(
                                  ...
                                  context: context, builder: (_) => const CategoryFilterBottomSheet());
                            },
                          ),
                        ),
                      );
                ...
                child: Consumer<ProductProvider>(
                    builder: (context, prodProvider, child) {
                      ...
                      return Stack(children: [
                          ...
                          const ProductSearchDialog():const SizedBox(),
                        ],
                      );
                    }
                ),
