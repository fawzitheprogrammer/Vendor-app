  ...
  Widget build(BuildContext context) {
    return Row(children: [
     ...
     widget.isFilter ? Padding(
        padding:  EdgeInsets.only(left :  Provider.of<LocalizationProvider>(context, listen: false).isLtr? Dimensions.paddingSizeExtraSmall : 0,
            right :  Provider.of<LocalizationProvider>(context, listen: false).isLtr? 0 : Dimensions.paddingSizeExtraSmall),
