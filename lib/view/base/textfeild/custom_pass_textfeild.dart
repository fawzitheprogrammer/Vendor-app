...
class CustomPasswordTextField extends StatefulWidget {
  ...
  const CustomPasswordTextField({Key? key, this.controller, this.hintTxt, this.focusNode, this.nextNode, this.textInputAction, this.border = false, this.prefixIconImage}) : super(key: key);
