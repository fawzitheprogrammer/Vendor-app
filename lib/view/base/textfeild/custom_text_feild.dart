  ...
  Widget build(context) {
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(prefixIconConstraints: BoxConstraints(
            minWidth: widget.variant ? 5 : 20,
            minHeight: widget.variant ? 5 : 20,),
          prefixIcon: widget.prefixIconImage != null ?
          Padding(padding: EdgeInsets.fromLTRB(Provider.of<LocalizationProvider>(context, listen: false).isLtr? 0: Dimensions.paddingSizeSmall , 0, Provider.of<LocalizationProvider>(context, listen: false).isLtr?Dimensions.paddingSizeSmall:0,0),
