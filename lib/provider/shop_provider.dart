...
import 'package:wave_mall_vendor/data/model/response/attribute_model.dart';
import 'package:wave_mall_vendor/data/model/response/base/api_response.dart';
import 'package:wave_mall_vendor/data/model/response/brand_model.dart';
import 'package:wave_mall_vendor/data/model/response/category_model.dart';
import 'package:wave_mall_vendor/data/model/response/config_model.dart';
import 'package:wave_mall_vendor/data/model/response/edt_product_model.dart';
...
import 'package:wave_mall_vendor/data/model/response/variant_type_model.dart';
...
class SellerProvider extends ChangeNotifier {
  ...
  Future<void> updateProductQuantity( BuildContext context, int? productId, int currentStock, List<Variation> variations ) async {
    ...
    _isLoading = true;
    ApiResponse apiResponse = await shopRepo!.updateProductQuantity(productId, currentStock, updatedVariations);
